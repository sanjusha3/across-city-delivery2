...
authorize('ADMIN'), AdminController.createUser)

router.get('/admin/user',
authorize('ADMIN'), AdminController.getUsers)

router.get('/admin/user/:id', 
authorize('ADMIN'), AdminController.getUserById)

router.patch('/admin/user/:id', 
authorize('ADMIN'), AdminController.getUserByIdAndUpdate)

router.delete('/admin/user/:id', 
authorize('ADMIN'), AdminController.deleteUser)
