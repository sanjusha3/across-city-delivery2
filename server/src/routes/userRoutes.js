...
authorize('USER'), UserController.getOrders)

router.get('/user/:id', 
authorize('USER'), UserController.getUserById)

router.patch('/user/:id', 
authorize('USER'), UserController.getUserByIdAndUpdate)

router.post('/user/order', 
authorize('USER'), UserController.createOrder)

router.get('/user/order/:id', 
authorize('USER'), UserController.getOrderById)

router.patch('/user/order/:id', 
authorize('USER'), UserController.getOrderByIdAndUpdate)

router.delete('/user/order/:id', 
authorize('USER'), UserController.deleteOrder)
